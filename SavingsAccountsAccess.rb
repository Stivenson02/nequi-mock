class SavingsAccountsAccess
    ...
    def send_money_to_another_user_savings_account(recipient_email, sent_money, savings_account_storage_id)
...
# savings_accounts_access.send_money_to_another_user_savings_account('stiven@gmail.com', 1000000, 1)
# db_connection.client.abandon_results!

# savings_accounts_access.send_money_to_another_user_savings_account('sergio@gmail.com', 500000, 3)
# db_connection.client.abandon_results!
